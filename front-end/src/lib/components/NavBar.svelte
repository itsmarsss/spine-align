...
<nav class="w-full flex flex-row h-20 justify-between px-8">
  ...
  <div class="flex justify-between gap-4 text-md items-center">
    <a class="rounded-xl bg-accent hover:translate-y-1 transition-transform text-white px-3 py-2 drop-shadow-xl" href="{base}/sign-up">
        Sign up
    </a>
    <a class="rounded-xl text-black hover:translate-y-1 transition-transform" href="{base}/log-in">
        Log in
    </a>
  </div>
</nav>